...
import 'rtp_transceiver_init.dart';
...
}) => RustLib.instance.api.crateApiRtcRtpTransceiverAddTransceiver(
  peer: peer,
  mediaType: mediaType,
  init: init,
);
...
Future<List<RtcRtpTransceiver>> getTransceivers({
  required ArcPeerConnection peer,
}) => RustLib.instance.api.crateApiRtcRtpTransceiverGetTransceivers(peer: peer);
...
}) => RustLib.instance.api.crateApiRtcRtpTransceiverSetTransceiverDirection(
...
Future<void> setTransceiverRecv({
  required ArcRtpTransceiver transceiver,
  required bool recv,
}) => RustLib.instance.api.crateApiRtcRtpTransceiverSetTransceiverRecv(
  transceiver: transceiver,
  recv: recv,
);
...
Future<void> setTransceiverSend({
  required ArcRtpTransceiver transceiver,
  required bool send,
}) => RustLib.instance.api.crateApiRtcRtpTransceiverSetTransceiverSend(
  transceiver: transceiver,
  send: send,
);
...
Future<String?> getTransceiverMid({required ArcRtpTransceiver transceiver}) =>
    RustLib.instance.api.crateApiRtcRtpTransceiverGetTransceiverMid(
      transceiver: transceiver,
    );
...
Future<RtpTransceiverDirection> getTransceiverDirection({
  required ArcRtpTransceiver transceiver,
}) => RustLib.instance.api.crateApiRtcRtpTransceiverGetTransceiverDirection(
  transceiver: transceiver,
);
...
Future<void> stopTransceiver({required ArcRtpTransceiver transceiver}) =>
    RustLib.instance.api.crateApiRtcRtpTransceiverStopTransceiver(
      transceiver: transceiver,
    );
