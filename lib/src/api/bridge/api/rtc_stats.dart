...
import '../lib.dart';
import 'rtc_ice_candidate_stats.dart';
import 'rtc_stats/ice_role.dart';
import 'rtc_stats/rtc_inbound_rtp_stream_media_type.dart';
import 'rtc_stats/rtc_media_source_stats_media_type.dart';
import 'rtc_stats/rtc_outbound_rtp_stream_media_type.dart';
import 'rtc_stats/rtc_stats_ice_candidate_pair_state.dart';

part 'rtc_stats.freezed.dart';
...
Future<List<RtcStats>> getPeerStats({required ArcPeerConnection peer}) =>
    RustLib.instance.api.crateApiRtcStatsGetPeerStats(peer: peer);
