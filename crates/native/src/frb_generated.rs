...
let mut var_noiseSuppressionLevel = <Option<crate::api::NoiseSuppressionLevel>>::sse_decode(deserializer);
...
<Option<crate::api::NoiseSuppressionLevel>>::sse_encode(self.noise_suppression_level, serializer);
